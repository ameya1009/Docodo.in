...
function LoginForm() {
  ...
  const [error, setError] = useState(
    urlError === "OAuthSignin" || urlError === "OAuthCallback" || urlError === "OAuthCreateAccount"
      ? "Google login failed. Please verify your Google account or sign in with email."
      : urlError
      ...
      <div className="glass rounded-2xl p-8 border border-[var(--border-default)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3.5 bg-[var(--lime)] text-[var(--bg-void)] font-bold rounded-xl hover:bg-[var(--lime-hover)] transition-colors flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed mt-2 shadow-md"
          >
            {isPending ? (
